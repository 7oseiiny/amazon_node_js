...
const {savesubCategory,getAllSubCategories,getSubCategory,updateSubCategory,deleteSubCategory} = require('../controllers/subcategory');
...
router.delete('/:id', async (req, res) => {
    try {
        ...
        if(deleteSubCat){
            ...
            res.status(404).json({deleted: false, data: deleteSubCat, message: "subCategory not found" })
